...
依照參考圖樣式重新繪製的 SHAP forest plot 與 SHAP beeswarm / summary dot plot：
...
- `0609_shap_beeswarm_top8.png`
- `0609_shap_beeswarm_top8.jpg`
- `0609_shap_beeswarm_top8.html`
- `0609_shap_beeswarm_top8_data.xlsx`
- `0609_shap_beeswarm_top8_data.csv`
...
Beeswarm / summary dot plot 使用同一組 top 8 features。每個點代表 temporal external validation cohort 中的一位住民；x 軸為 SHAP value，顏色為該住民在該 feature 的原始 feature value。此圖對應參考圖中紅藍點狀分布與右側 `Feature value` colorbar 的樣式。
...
- SHAP beeswarm plot PNG / JPG / HTML
- SHAP beeswarm long-form data CSV / XLSX
